...
class UserRelation(models.Model):
    ...
    friend = models.ForeignKey(User,on_delete=models.CASCADE,related_name="friend_relations")
    accepted = models.BooleanField(default=False)
    relation_key = models.CharField(max_length=225,blank = True,null=True)
...
class Messages(models.Model):
    ...
    timestamp = models.DateTimeField(timezone.now,blank=True)
